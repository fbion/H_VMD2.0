...
var KisBpmExecutionListenersPopupCtrlExt = ['$scope', '$q', '$translate', function ($scope, $q, $translate) {
    ...
    $scope.$watch('$parent.selectedItem', function (newValue, oldValue) {
        ...
        if (newValue) {
            ...
            for (var i = 0; i < newValue.properties.length; i++) {
                if (newValue.properties[i].key.toString() == "oryx-executionlisteners") {
            ...
            //$scope.property = newValue.properties[6];
