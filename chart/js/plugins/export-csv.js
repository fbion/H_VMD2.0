...
(function (factory) {
    ...
    Highcharts.Chart.prototype.getDataRows = function () {
        var options = (this.options.exporting || {}).csv || {},
            ...
            // Options
            dateFormat = options.dateFormat ||  xAxis.options.dateTimeLabelFormats[tickPositionInfo.unitName] || '%Y-%m-%d %H:%M:%S',
        ...
        // Add header row
        if (!xTitle) {
            xTitle = xAxis.isDatetimeAxis ? unescape("%u65F6%u95F4")/*时间*/ : unescape("%u7C7B%u522B")/*类别*/;
        }
