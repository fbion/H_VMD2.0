 ...
 ** 版 本:1.1
 ******************************************************************/
Ext.define('vmd.d.webchart.Well',{
	extend:'vmd.base.WebChart',
	xtype:'vmd.d.webchart.Well',
	requires:[
	...
	onRender: function(ct, position) {
		...
		// 是否存在内存对象
		var mgr=vmd.d.webchart.Well.Mgr;
		...
		if(tempObj&&tempObj.tpl){
			...
			if(me.path){
				...
				var path = '/design/webchart/templates/well.json';
			}
     ...
     * **/
		...
		var fileName = me.viewerNode.id+'well.json';
	...
	vmd.d.webchart.Well.Mgr= new Ext.util.MixedCollection();
})
