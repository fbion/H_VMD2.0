...
xds.vmdHeaderCustomButton = Ext.extend(xds.Component, {
    cid: "vmdHeaderCustomButton",
    category: "vmdReport组件",
    defaultName: "&lt;headerbutton&gt;",
    text: "headerbutton(表头定制)",
    dtype: "vmd.vmdHeaderCustomButton",
    //这里的xtype主要是为了代码显示的类型，本身无任何作用
    xtype: "vmd.vmdHeaderCustomButton",
    xcls: "vmd.comp.vmdHeaderCustomButton",
...
if (typeof xds != "undefined") {
    xds.Registry.register(xds.vmdHeaderCustomButton)
}
//#region vmdbutton
Ext.define("vmd.comp.vmdHeaderCustomButton", {
