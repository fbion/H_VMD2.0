...
xds.vmdExportExcelButton = Ext.extend(xds.Component, {
    cid: "vmdExportExcelButton",
    category: "vmdReport组件",
    defaultName: "&lt;exportbutton&gt;",
    text: "exportbutton(导出按钮)",
    dtype: "vmd.vmdExportExcelButton",
    //这里的xtype主要是为了代码显示的类型，本身无任何作用
    xtype: "vmd.vmdExportExcelButton",
    xcls: "vmd.comp.vmdExportExcelButton",
...
if (typeof xds != "undefined") {
    xds.Registry.register(xds.vmdExportExcelButton)
}
//#region vmdbutton
Ext.define("vmd.comp.vmdExportExcelButton", {
