Vmd.define('hwchart.coord.geo.GeoModel', {
    requires: [
    ...
    var selectableMixin = hwchart.component.helper.selectableMixin;

    var geoCreator = hwchart.coord.geo.geoCreator;

    var GeoModel = ComponentModel.extend({
        type: 'geo',

        /**
         * @type {module:hwcharts/coord/geo/Geo}
         */
    ...
    hwchart.coord.geo.GeoModel = GeoModel;
})