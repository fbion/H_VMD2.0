Vmd.define('hwchart.coord.geo.geoSVGLoader', {
    requires: [
        'hwchart.util.model'
    ]
}, function () {

    var parseSVG = zrender.parseSVG;
    var makeViewBoxTransform = zrender.makeViewBoxTransform;
    ...
    hwchart.coord.geo.geoSVGLoader = _default;
})