Vmd.define('hwchart.layout.barGrid',
    {
        requires: [
          'hwchart.util.number',
    ...
    function () {
        ...
        /**
         * @param {Object} opt
         * @param {module:hwcharts/coord/Axis} opt.axis Only support category axis currently.
         ...
         * @param {module:hwcharts/model/Series} [seriesModel] If not provided, return all.
        ...
        hwchart.layout.barGrid = exports;
    })