Vmd.define('hwchart.scale.Interval', {
    requires: [
        'hwchart.scale.Scale',
        'hwchart.util.number',
        'hwchart.util.format',
    ...
    var helper = hwchart.scale.helper;



    /**
     * Interval scale
     * @module hwcharts/scale/Interval
     */
    var roundNumber = numberUtil.round;
    /**
     * @alias module:hwcharts/coord/scale/Interval
     * @constructor
     */
    ...
    hwchart.scale.Interval = IntervalScale
})