Vmd.define('hwchart.util.graphic',{}, function () {
    ...
    var Sector = zrender.Sector;

    exports.Sector = Sector;

    var Ring = zrender.Ring;
    ...
    var BezierCurve = zrender.BezierCurve;
    ...
    var CompoundPath = zrender.CompoundPath;
    ...
    var RadialGradient = zrender.RadialGradient;
    ...
    var subPixelOptimizeUtil = zrender.subPixelOptimize;
     ...
     *
     * [Caution]:
     * (1) This method **MUST NOT be used inside hwcharts !!!**, unless it is prepared
     * to use user registered shapes.
     * Because the built-in shape (see `getBuiltInShape`) will be registered by
     * `registerShape` by default. That enables users to get both built-in
     * shapes as well as the shapes belonging to themsleves. But users can overwrite
     * the built-in shapes by using names like 'circle', 'rect' via calling
     * `registerShape`. So the hwcharts inner featrues should not fetch shapes from here
    ...
    function singleEnterEmphasis(el) {
        ...
        // module:hwcharts/util/model#defaultEmphasis to merge `normal` to `emphasis`.
     ...
     *
     *        FIXME
     *        CAUTION: Do not expose `highDownOnUpdate` outside hwcharts.
     ...
     * @param {module:hwcharts/model/Model} normalModel
     * @param {module:hwcharts/model/Model} emphasisModel
     * @param {Object} opt Check `opt` of `setTextStyleCommon` to find other props.
     * @param {string|Function} [opt.defaultText]
     * @param {module:hwcharts/model/Model} [opt.labelFetcher] Fetch text by
     *      `opt.labelFetcher.getFormattedLabel(opt.labelDataIndex, 'normal'/'emphasis', null, opt.labelDimIndex)`
     * @param {module:hwcharts/model/Model} [opt.labelDataIndex] Fetch text by
     *      `opt.textFetcher.getFormattedLabel(opt.labelDataIndex, 'normal'/'emphasis', null, opt.labelDimIndex)`
     * @param {module:hwcharts/model/Model} [opt.labelDimIndex] Fetch text by
     *      `opt.textFetcher.getFormattedLabel(opt.labelDataIndex, 'normal'/'emphasis', null, opt.labelDimIndex)`
     ...
     * @param {module:hwcharts/model/Model} labelModel
     ...
     * @param {module:zrender/Element} el
     * @param {Object} props
     * @param {module:hwcharts/model/Model} [animatableModel]
