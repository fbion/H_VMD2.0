Vmd.define('hwchart.util.layout', {
    requires: [
        'hwchart.util.format',
        'hwchart.util.number'
    ]
        ...
        if (!style.left && !style.right) {
            switch (style.textAlign) {
                case 'left':
                    ...
                    break;
                case 'right':
                    layoutInfo.right = 'right'
                    break;
                default:
                    layoutInfo.left = 'center';
                    break;
            }
        }
        if (!style.top && !style.bottom) {
            switch (style.textVerticalAlign) {
                case 'top':
                    ...
                    break;
                case 'bottom':
                    layoutInfo.bottom = 'bottom'
                    break;
                default:
                    layoutInfo.top = 'middle';
                    break;
            }
        }
        return layoutInfo;
    ...
    //hwextend
    exports.isPointInBody = isPointInBody;
    exports.getLayoutInfo = getLayoutInfo;

    hwchart.util.layout = exports;
})