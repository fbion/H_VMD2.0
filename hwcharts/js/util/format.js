Vmd.define('hwchart.util.format', {
    requires:['hwchart.util.number']
     ...
     *           see `module:hwcharts/scale/Time`
     *           and `module:hwcharts/util/number#parseDate`.
     * @inner
     */
