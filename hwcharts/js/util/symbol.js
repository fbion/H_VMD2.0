Vmd.define('hwchart.util.symbol', {
    requiers: [
    ...
    var _text = zrender.contain.text;
    ...
    var SymbolClz = graphic.extendShape({
        ...
        buildPath: function (ctx, shape, inBundle) {
            ...
            if (symbolType !== 'none') {
                ...
                //hwextend
                if (shape.keepShape) {
                    proxySymbol.shape = shape.keepShape;
                }else
    ...
    function createSymbol(symbolType, x, y, w, h, color, keepAspect, keepShape) {
    ...
    hwchart.util.symbol.createSymbol = createSymbol;
