Vmd.define('hwchart.data.helper.sourceHelper', {
    requires: [
        'hwchart.util.model',
        'hwchart.data.Source',
    ...
    var inner = makeInner();
    /**
     * @see {module:hwcharts/data/Source}
     * @param {module:hwcharts/component/dataset/DatasetModel} datasetModel
    ...
    var exports = {};
    hwchart.data.helper.sourceHelper = exports;
