Vmd.define('hwchart.data.helper.completeDimensions', {
    requires: [
        'hwchart.util.model',
    ...
    /**
     * @deprecated
     * Use `hwcharts/data/helper/createDimensions` instead.
     */

    /**
     * @see {module:hwcharts/test/ut/spec/data/completeDimensions}
     *
     ...
     * @param {module:hwcharts/data/Source|Array|Object} source or data (for compatibal with pervious)
     * @param {Object} [opt]
    ...
    hwchart.data.helper.completeDimensions = _default;
