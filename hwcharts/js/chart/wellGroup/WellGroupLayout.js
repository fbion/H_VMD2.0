Vmd.define('hwchart.chart.wellGroup.wellGroupLayout', {
    
}, function () {
    hwchart.chart.wellGroup.wellGroupLayout = function (ecModel) {
        ecModel.eachSeriesByType('wellGroup', function (seriesModel) {
