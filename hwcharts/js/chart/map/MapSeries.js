Vmd.define('hwchart.chart.map.MapSeries', {
    requires: [
        'hwchart.data.helper.dataProvider',
        'hwchart.chart.helper.createListSimply',
        'hwchart.model.Series',
        'hwchart.util.format',
        'hwchart.component.helper.selectableMixin',
    ...
    var createListSimply = hwchart.chart.helper.createListSimply;
    ...
    var dataSelectableMixin = hwchart.component.helper.selectableMixin;
    ...
    hwchart.chart.map.MapSeries = MapSeries;
})