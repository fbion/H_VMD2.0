Vmd.define('hwchart.chart.isoLine.IsoLineSeries', {
    requires: [
    ...
    function preprocessOption(seriesOpt) {
        ...
        if (data && data[0] && data[0].coords) {
            seriesOpt.data = map(data, function (itemOpt) {
                ...
                each(itemOpt.coords, function (coord) {
    ...
    var IsoLineSeries = SeriesModel.extend({
        ...
        init: function (option) {
            ...
            IsoLineSeries.superApply(this, 'init', arguments);
        },
        ...
        mergeOption: function (option) {
            ...
            IsoLineSeries.superApply(this, 'mergeOption', arguments);
        },
        ...
        defaultOption: {
            ...
            segInterval: 200, //等值线每间隔多少像素绘制一个标签
            labelPadding: 8,
    ...
    hwchart.chart.isoLine.IsoLineSeries = IsoLineSeries;
})