Vmd.define('hwchart.chart.wellLogging.dataZoom.SliderZoomView', {
    requires: [
    ...
    hwchart.chart.wellLogging.dataZoom.SliderZoomView = SliderZoomView;
})