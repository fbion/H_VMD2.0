Vmd.define('hwchart.chart.isoArea.IsoAreaSeries', {
    requires: [
    ...
    function preprocessOption(seriesOpt) {
        ...
        if (data && data[0] && data[0].coords) {
            seriesOpt.data = map(data, function (itemOpt) {
                ...
                itemOpt.value = itemOpt.minValue;
                return itemOpt;
            });
        }
    }

    var IsoAreaSeries = SeriesModel.extend({
        ...
        init: function (option) {
            ...
            IsoAreaSeries.superApply(this, 'init', arguments);
        },
        ...
        mergeOption: function (option) {
            ...
            IsoAreaSeries.superApply(this, 'mergeOption', arguments);
        },
    ...
    hwchart.chart.isoArea.IsoAreaSeries = IsoAreaSeries;
})