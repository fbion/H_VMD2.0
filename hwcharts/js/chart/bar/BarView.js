Vmd.define('hwchart.chart.bar.BarView', {
    requires: [
        'hwchart.util.graphic',
        'hwchart.chart.bar.helper',
        'hwchart.model.Model',
        'hwchart.chart.bar.barItemStyle',
        'hwchart.util.throttle',
        'hwchart.chart.helper.createClipPathFromCoordSys',
        'hwchart.util.shape.sausage'
    ]
    ...
    var _helper = hwchart.chart.bar.helper;

    var setLabel = _helper.setLabel;

    var Model = hwchart.model.Model;

    var barItemStyle = hwchart.chart.bar.barItemStyle;

    var Path = zrender.Path;
    ...
    var Sausage = hwchart.util.shape.sausage;
    ...
    hwchart.chart.bar.BarView = _default;
