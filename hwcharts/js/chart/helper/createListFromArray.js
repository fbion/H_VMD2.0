...
Vmd.define('hwchart.chart.helper.createListFromArray', {
    requires: [
        'hwchart.data.List',
        'hwchart.data.Source',
    ...
    var _referHelper = hwchart.model.referHelper;
    ...
    /**
     * @param {module:hwcharts/data/Source|Array} source Or raw data.
    ...
    hwchart.chart.helper.createListFromArray = createListFromArray;
})