Vmd.define('hwchart.chart.helper.Line', {
    requires: [
        'hwchart.util.symbol',
        'hwchart.util.graphic',
        'hwchart.util.number',
        'hwchart.chart.helper.LinePath'
    ]
    ...
    var vector = zrender.vector;

    var symbolUtil = hwchart.util.symbol;

    var LinePath = hwchart.chart.helper.LinePath;
    ...
    /**
     * @module hwcharts/chart/helper/Line
     */
     ...
     * @alias {module:hwcharts/chart/helper/Line}
     */
    ...
    hwchart.chart.helper.Line = Line;
})