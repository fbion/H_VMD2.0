Vmd.define('hwchart.chart.line.LineView', {
    requires: [
        'hwchart.view.Chart',
        'hwchart.chart.helper.SymbolDraw',
        'hwchart.chart.helper.Symbol',
        'hwchart.chart.line.lineAnimationDiff',
        'hwchart.util.graphic',
        'hwchart.util.model',
        'hwchart.chart.helper.Symbol',
        'hwchart.chart.line.poly',
        'hwchart.chart.line.helper',
    ...
    var lineAnimationDiff = hwchart.chart.line.lineAnimationDiff;

    var graphic = hwchart.util.graphic;

    var modelUtil = hwchart.util.model;

    var _poly = hwchart.chart.line.poly;
    ...
    var _helper = hwchart.chart.line.helper;
    ...
    /**
     * @param {module:hwcharts/coord/cartesian/Cartesian2D|module:hwcharts/coord/polar/Polar} coordSys
    ...
    hwchart.chart.line.LineView = _default;
})