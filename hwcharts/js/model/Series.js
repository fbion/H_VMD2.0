Vmd.define('hwchart.model.Series', {
    requires: [
        'hwchart.util.format',
        'hwchart.util.clazz',
        'hwchart.model.Component',
        'hwchart.util.layout',
        'hwchart.model.mixin.colorPalette',
        'hwchart.model.mixin.dataFormat',
        'hwchart.util.model',
        'hwchart.stream.task',
    ...
    var colorPaletteMixin = hwchart.model.mixin.colorPalette;

    var dataFormatMixin = hwchart.model.mixin.dataFormat;
    ...
    var SeriesModel = ComponentModel.extend({
         ...
         */
        seriesIndex: 0,
        // coodinateSystem will be injected in the hwcharts/CoordinateSystem
        ...
        init: function (option, parentModel, ecModel, extraOpt) {
            ...
            /**
             * @type {module:hwcharts/data/List|module:hwcharts/data/Tree|module:hwcharts/data/Graph}
             * @private
             */
            inner(this).dataBeforeProcessed = data; // If we reverse the order (make data firstly, and then make
            // dataBeforeProcessed by cloneShallow), cloneShallow will
            // cause data.graph.data !== data when using
            // module:hwcharts/data/Graph or module:hwcharts/data/Tree.
            // See module:hwcharts/data/helper/linkList
         ...
         * @return {module:hwcharts/data/List}
         */
        ...
        /**
         * @see {module:hwcharts/data/helper/sourceHelper#getSource}
         * @return {module:hwcharts/data/Source} source
         */
        getSource: function () {
         ...
         * @param {module:hwcharts/coord/single/SingleAxis} baseAxis
        ...
        /**
         * @see {module:hwcharts/stream/Scheduler}
         */
        pipeTask: null,
    ...
    hwchart.model.Series = SeriesModel;
