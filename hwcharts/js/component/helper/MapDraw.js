Vmd.define('hwchart.component.helper.MapDraw', {
    ...
    var roamHelper = hwchart.component.helper.roamHelper;
        ...
        draw: function (mapOrGeoModel, ecModel, api, fromView, payload) {
            ...
            if (geo._roamTransformable.transform) {
                //group.transform = geo._roamTransformable.transform.slice();
								group.transform = zrender.util.clone(geo._roamTransformable.transform);
    ...
    hwchart.component.helper.MapDraw = MapDraw;
})