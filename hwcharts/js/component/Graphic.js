Vmd.define('hwchart.component.Graphic', {
    requires: [
        'hwchart.util.model',
    ...
    hwcharts.registerPreprocessor(function (option) {
        ...
        if (zrUtil.isArray(graphicOption)) {
            if (!graphicOption[0] || !graphicOption[0].elements) {
                ...
                // want that too many views are created in hwcharts._viewMap)
    ...
    var GraphicModel = hwcharts.extendComponentModel({
        type: 'graphic',
        defaultOption: {
    ...
    hwcharts.extendComponentView({
        ...
        init: function (ecModel, api) {
            ...
            /**
             * @private
             * @type {module:hwcharts/graphic/GraphicModel}
             */
         ...
         * @private
         * @param {Object} graphicModel graphic model
         * @param {module:hwcharts/ExtensionAPI} api extension API
         */
