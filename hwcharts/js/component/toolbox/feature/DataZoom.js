Vmd.define('hwchart.component.toolbox.feature.DataZoom', {
    requires: [
    ...
    var each = zrUtil.each; // Spectial component id start with \0ec\0, see hwcharts/model/Global.js~hasInnerId
    ...
    hwchart.component.toolbox.feature.DataZoom = DataZoom;
})