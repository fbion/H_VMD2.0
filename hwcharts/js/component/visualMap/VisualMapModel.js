Vmd.define('hwchart.component.visualMap.VisualMapModel', {
    requires: [
    ...
    var VisualMapModel = hwcharts.extendComponentModel({
        type: 'visualMap',
        dependencies: ['series'],
         ...
         * @public
         * @abstract
         * @param {*|module:hwcharts/data/List} valueOrData
    ...
    hwchart.component.visualMap.VisualMapModel = VisualMapModel;
