Vmd.define('hwchart.component.visualMap.ContinuousView', {
    requires: [
        'hwchart.component.visualMap.VisualMapView',
        'hwchart.component.visualMap.helper',
        'hwchart.util.number',
    ...
    var LinearGradient = zrender.LinearGradient;

    var eventTool = zrender.event;

    var VisualMapView = hwchart.component.visualMap.VisualMapView;
    ...
    var helper = hwchart.component.visualMap.helper;
    ...
    hwchart.component.visualMap.ContinuousView = ContinuousView;
