Vmd.define('hwchart.component.dataZoom.DataZoomModel', {
    requires: [
        'hwchart.util.model',
        'hwchart.component.dataZoom.helper',
        'hwchart.component.dataZoom.AxisProxy'
    ]
}, function (scope) {
    ...
    var AxisProxy = hwchart.component.dataZoom.AxisProxy;
    ...
    hwchart.component.dataZoom.DataZoomModel = DataZoomModel;
})