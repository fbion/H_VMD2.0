Vmd.define('hwchart.component.axis.AxisBuilder', {
    requires: [
        'hwchart.util.format',
    ...
    var matrixUtil = zrender.matrix;

    var _vector = zrender.vector;
    ...
    hwchart.component.axis.AxisBuilder = AxisBuilder
