Vmd.define('hwchart.component.legend.LegendView', {
    ...
    var _default = hwcharts.extendComponentView({
            ...
            each(legendModel.getData(), function (itemModel, dataIndex) {
                ...
                if (seriesModel) {
                    ...
                    if (seriesModel.subType == 'miningIndex') {
                        ...
                        if (data._rawData.length > 0) {
                            for (var i = 0; i < data._rawData[0].name.length; i++) {
                                name = data._rawData[0].name[i];
                                color = data._rawData[0].color[i];
                                ...
                                var itemGroup = this._createItem(
                                    ...
                                    itemAlign, color,
                                    borderColor, selectMode, seriesModel);
                        ...
                        var itemGroup = this._createItem(name, dataIndex, itemModel, legendModel, legendSymbolType, symbolType, itemAlign, color, borderColor, selectMode, seriesModel);
        ...
        _createItem: function (name, dataIndex, itemModel, legendModel, legendSymbolType, symbolType, itemAlign, color, borderColor, selectMode, seriesModel) {
        ...
        updateTransform: function (componentModel, ecModel, api, payload) {
            ...
            var xyPix = geo.coordinateSystem.dataToPoint([_boudingRect.x + _boudingRect.width, _boudingRect.y]);

            var grect = group.getBoundingRect();

            group.position[0] = xyPix[0] - grect.width * zoomFactor;
            group.position[1] = xyPix[1] - grect.height * zoomFactor;
            group.dirty()
        },
        /**
         * @protected
