Vmd.define('hwchart.component.brush.BrushModel', {
    requires: [
    ...
    var BrushModel = hwcharts.extendComponentModel({
        type: 'brush',
         ...
         * see module:hwcharts/component/helper/BrushController
         * @readOnly
         * @type {string}
         */
        brushType: null,
    ...
    hwchart.component.brush.BrushModel = BrushModel;
})