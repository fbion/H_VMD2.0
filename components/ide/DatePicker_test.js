xds["vmd.ux.DatePicker_test"] = Ext.extend(xds.Component, {
    cid: "vmd.ux.DatePicker_test",
    category: "vmd复合组件",
    text: "DatePicker_test",//中文
    naming: "hwDatePicker_test",
    //dtype 设计时组件
    dtype: "vmd.ux.DatePicker_test",
    //xtype 运行时组件
    xtype: "vmd.ux.DatePicker_test",
    xcls: "vmd.ux.DatePicker_test",
    //为了拖拽能自动生成递增id
    defaultName: "hwDatePicker_test",
    iconCls: "icon-cmp",
    isContainer: false,
     //扩展组件依赖资源加载
    requireCss: [],
    ...
    xds.Registry.register(xds["vmd.ux.DatePicker_test"]);
    xds.Registry.addUserType(xds["vmd.ux.DatePicker_test"]);

    var Data_vmd_ux_DatePicker_test={"BaseType":"Control","Type":"vmd_ux_DatePicker_test","Property":{"ksrqLabel":{"Description":"ksrqLabel","Prototype":"","Args":{"_Return_":""},"Example":""},"jsrqLabel":{"Description":"jsrqLabel","Prototype":"","Args":{"_Return_":""},"Example":""},"isRange":{"Description":"isRange","Prototype":"","Args":{"_Return_":""},"Example":""},"hasShortcut":{"Description":"hasShortcut","Prototype":"","Args":{"_Return_":""},"Example":""},"format":{"Description":"format","Prototype":"","Args":{"_Return_":""},"Example":""},"shortCutType":{"Description":"shortCutType","Prototype":"","Args":{"_Return_":""},"Example":""},"defaultValue":{"Description":"defaultValue","Prototype":"","Args":{"_Return_":""},"Example":""}},"Method":{"getValue":{"Description":"getValue","Prototype":"getValue()","Args":{"_Return_":"void","Args":""},"Example":""},"setValue":{"Description":"setValue","Prototype":"setValue(rq1,rq2)","Args":{"_Return_":"void","Args":"rq1,rq2"},"Example":""},"getKsrq":{"Description":"getKsrq","Prototype":"getKsrq()","Args":{"_Return_":"void","Args":""},"Example":""},"getJsrq":{"Description":"getJsrq","Prototype":"getJsrq()","Args":{"_Return_":"void","Args":""},"Example":""}},"Event":{"select":{"Description":"","Prototype":"","Args":{"_Return_":""},"Example":""},"change":{"Description":"","Prototype":"","Args":{"_Return_":""},"Example":""},"loaded":{"Prototype":"","Args":{"_Return_":""},"Example":""}}}
	ControlsDataManage._add(Data_vmd_ux_DatePicker_test)