xds["vmd.ux.TabWorkSpaceInfoNew"] = Ext.extend(xds.Component, {
    cid: "vmd.ux.TabWorkSpaceInfoNew",
    category: "vmd复合组件",
    text: "TabWorkSpaceInfoNew",//中文
    naming: "TabWorkSpaceInfoNew",
    //dtype 设计时组件
    dtype: "vmd.ux.TabWorkSpaceInfoNew",
    //xtype 运行时组件
    xtype: "vmd.ux.TabWorkSpaceInfoNew",
    xcls: "vmd.ux.TabWorkSpaceInfoNew",
    //为了拖拽能自动生成递增id
    defaultName: "TabWorkSpaceInfoNew",
    iconCls: "icon-cmp",
    isContainer: false,
