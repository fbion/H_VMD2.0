xds["vmd.ux.CreateCalendar"] = Ext.extend(xds.Component, {
    cid: "vmd.ux.CreateCalendar",
    category: "vmd复合组件",
    text: "CreateCalendar",//中文
    naming: "CreateCalendar",
    //dtype 设计时组件
    dtype: "vmd.ux.CreateCalendar",
    //xtype 运行时组件
    xtype: "vmd.ux.CreateCalendar",
    xcls: "vmd.ux.CreateCalendar",
    //为了拖拽能自动生成递增id
    defaultName: "CreateCalendar",
    iconCls: "icon-cmp",
    isContainer: false,
