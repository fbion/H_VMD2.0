xds["vmd.ux.ProjectAuthority"] = Ext.extend(xds.Component, {
    cid: "vmd.ux.ProjectAuthority",
    category: "vmd复合组件",
    text: "ProjectAuthority",//中文
    naming:"projectauthority",
    //dtype 设计时组件
    dtype: "vmd.ux.ProjectAuthority",
    //xtype 运行时组件
    xtype: "vmd.ux.ProjectAuthority",
    xcls: "vmd.ux.ProjectAuthority",
    //为了拖拽能自动生成递增id
    defaultName:"projectauthority",
    iconCls: "icon-cmp",
    isContainer: false,
    ...
    configs: [
     ...
     ,{"name":"storeWorkflow","group":"设计","ctype":"string","editor":"options","edConfig":{"type":"store"}}
