xds["vmd.ux.ZyglTree1"] = Ext.extend(xds.Component, {
    cid: "vmd.ux.ZyglTree1",
    category: "vmd复合组件",
    text: "ZyglTree1",//中文
    naming: "ZyglTree1",
    //dtype 设计时组件
    dtype: "vmd.ux.ZyglTree1",
    //xtype 运行时组件
    xtype: "vmd.ux.ZyglTree1",
    xcls: "vmd.ux.ZyglTree1",
    //为了拖拽能自动生成递增id
    defaultName: "ZyglTree1",
    iconCls: "icon-cmp",
    isContainer: false,
