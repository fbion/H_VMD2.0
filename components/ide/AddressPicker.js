xds["vmd.ux.AddressPicker"] = Ext.extend(xds.Component, {
    cid: "vmd.ux.AddressPicker",
    category: "vmd复合组件",
    text: "AddressPicker",//中文
    naming: "hwAddressPicker",
    //dtype 设计时组件
    dtype: "vmd.ux.AddressPicker",
    //xtype 运行时组件
    xtype: "vmd.ux.AddressPicker",
    xcls: "vmd.ux.AddressPicker",
    //为了拖拽能自动生成递增id
    defaultName: "hwAddressPicker",
    iconCls: "icon-cmp",
    isContainer: false,
     //扩展组件依赖资源加载
    requireCss: [],
    ...
    configs: [
     ...
     ,{"name":"detailWidth","group":"设计","ctype":"number","editor":"number"},{"name":"comboWidth","group":"设计","ctype":"number","editor":"number"},{"name":"pickerWidth","group":"设计","ctype":"number","editor":"number"},{"name":"detailX","group":"设计","ctype":"number","editor":"number"},{"name":"detailEmptyText","group":"设计","ctype":"string","editor":"string"}
