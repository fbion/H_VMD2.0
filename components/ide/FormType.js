xds["vmd.ux.FormType"] = Ext.extend(xds.Component, {
    cid: "vmd.ux.FormType",
    category: "vmd复合组件",
    text: "FormType",//中文
    naming: "hwFormType",
    //dtype 设计时组件
    dtype: "vmd.ux.FormType",
    //xtype 运行时组件
    xtype: "vmd.ux.FormType",
    xcls: "vmd.ux.FormType",
    //为了拖拽能自动生成递增id
    defaultName: "hwFormType",
    iconCls: "icon-cmp",
    isContainer: false,
     //扩展组件依赖资源加载
    ...
    xds.Registry.register(xds["vmd.ux.FormType"]);
    xds.Registry.addUserType(xds["vmd.ux.FormType"]);

    var Data_vmd_ux_FormType={"BaseType":"Control","Type":"vmd_ux_FormType","Property":{},"Method":{"serialize":{"Description":"serialize","Prototype":"serialize(info)","Args":{"_Return_":"void","Args":"info"},"Example":""},"setInfo":{"Description":"setInfo","Prototype":"setInfo(info)","Args":{"_Return_":"void","Args":"info"},"Example":""},"initDefault":{"Description":"initDefault","Prototype":"initDefault()","Args":{"_Return_":"void","Args":""},"Example":""}},"Event":{"copyGridToForm":{"Description":"","Prototype":"","Args":{"_Return_":""},"Example":""},"compareDataSet":{"Description":"","Prototype":"","Args":{"_Return_":""},"Example":""},"settingChangeEvents":{"Prototype":"","Args":{"_Return_":""},"Example":""}}}
	ControlsDataManage._add(Data_vmd_ux_FormType)