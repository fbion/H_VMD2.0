xds["vmd.ux.Authority"] = Ext.extend(xds.Component, {
    cid: "vmd.ux.Authority",
    category: "vmd复合组件",
    text: "Authority",//中文
    naming: "Authority",
    //dtype 设计时组件
    dtype: "vmd.ux.Authority",
    //xtype 运行时组件
    xtype: "vmd.ux.Authority",
    xcls: "vmd.ux.Authority",
    //为了拖拽能自动生成递增id
    defaultName: "Authority",
    iconCls: "icon-cmp",
    isContainer: false,
