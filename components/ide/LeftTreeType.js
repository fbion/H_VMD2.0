xds["vmd.ux.LeftTreeType"] = Ext.extend(xds.Component, {
    cid: "vmd.ux.LeftTreeType",
    category: "vmd复合组件",
    text: "LeftTreeType",//中文
    naming: "hwLeftTreeType",
    //dtype 设计时组件
    dtype: "vmd.ux.LeftTreeType",
    //xtype 运行时组件
    xtype: "vmd.ux.LeftTreeType",
    xcls: "vmd.ux.LeftTreeType",
    //为了拖拽能自动生成递增id
    defaultName: "hwLeftTreeType",
    iconCls: "icon-cmp",
    isContainer: false,
     //扩展组件依赖资源加载
    requireCss: [],
