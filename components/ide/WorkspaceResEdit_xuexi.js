xds["vmd.ux.WorkspaceResEdit_xuexi"] = Ext.extend(xds.Component, {
    cid: "vmd.ux.WorkspaceResEdit_xuexi",
    category: "vmd复合组件",
    text: "WorkspaceResEdit_xuexi",//中文
    naming:"workspaceresedit_xuexi",
    //dtype 设计时组件
    dtype: "vmd.ux.WorkspaceResEdit_xuexi",
    //xtype 运行时组件
    xtype: "vmd.ux.WorkspaceResEdit_xuexi",
    xcls: "vmd.ux.WorkspaceResEdit_xuexi",
    //为了拖拽能自动生成递增id
    defaultName:"workspaceresedit_xuexi",
    iconCls: "icon-cmp",
    isContainer: false,
