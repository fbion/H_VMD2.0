xds["vmd.ux.PublicListView"] = Ext.extend(xds.Component, {
    cid: "vmd.ux.PublicListView",
    category: "vmd复合组件",
    text: "PublicListView",//中文
    naming: "hwPublicListView",
    //dtype 设计时组件
    dtype: "vmd.ux.PublicListView",
    //xtype 运行时组件
    xtype: "vmd.ux.PublicListView",
    xcls: "vmd.ux.PublicListView",
    //为了拖拽能自动生成递增id
    defaultName: "hwPublicListView",
    iconCls: "icon-cmp",
    isContainer: false,
