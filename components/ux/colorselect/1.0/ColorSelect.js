Ext.define('vmd.ux.colorSelect.Controller', {
    xtype: 'vmd.ux.colorSelect.Controller',
    constructor: function(options) {}
})
Ext.define("vmd.ux.ColorSelect", {
    extend: "vmd.base.Ux",
    ...
    listeners: {
        vmdafterrender: function() {
            try {
                this.ColorSelect_afterrender(this)
            } catch (ex) {
                vmd.Error.log('003-2', {
                    p1: 'vmd.ux.ColorSelect'
                }, ex, 50);
            }
        }
    },
    ...
    initComponent: function() {
        ...
        this.ColorSelect_afterrender = ColorSelect_afterrender;
        this.items = [{
                xtype: "panel",
                id: "panel",
                title: "Panel",
        ...
        Ext.util.CSS.removeStyleSheet("vmd.ux.ColorSelect");
        this.uxCss && Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.ColorSelect");
    }
})