...
Ext.define("vmd.ux.SelectColor1", {
    extend: "vmd.base.Ux",
    ...
    height: 187,
    layout: "border",
    afterrender: "SelectColor1_afterrender",
    listeners: {
        vmdafterrender: function() {
            try {
                this.SelectColor1_afterrender(this)
            } catch (ex) {
                vmd.Error.log('003-2', {
                    p1: 'vmd.ux.SelectColor1'
                }, ex, 50);
            }
        }
    },
    ...
    initComponent: function() {
        ...
        this.SelectColor1_afterrender = SelectColor1_afterrender;
        this.items = [{
            xtype: "vmd.div",
            id: "hwDiv",
            autoEl: "div",
        ...
        Ext.util.CSS.removeStyleSheet("vmd.ux.SelectColor1");
        this.uxCss && Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.SelectColor1");
    }
})