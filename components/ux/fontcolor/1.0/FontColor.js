...
Ext.define("vmd.ux.FontColor", {
    ...
    autoHeight: false,
    beforerender: "FontColor_beforerender",
    listeners: {
        ...
        beforerender: function() {
            try {
                this.FontColor_beforerender(this)
            } catch (ex) {
                vmd.Error.log('003-1', {
                    p1: 'vmd.ux.FontColor'
                }, ex, 50);
    ...
    initComponent: function() {
        ...
        try {
            ...
            function FontColor_beforerender(sender) {
        ...
        this.FontColor_beforerender = FontColor_beforerender;
        this.items = [{
                xtype: "vmd.dataview",
                id: "hwDataView",
                width: 40,
                ...
                multiSelect: false,
                autoScroll: false,
                tpl: "<ul class=\"d-info\" style=\"display: inline-block;height: 36px;\">    <li class=\"info icon\" style=\"float:left;width: 24px;height:30px;padding: 0;margin:0\"> <i class=\"icon-font\" style=\" display:block;width:24px;height:20px;font-weight:bold;color:#333;text-align:center; line-height: 24px\"> </i>        <p class='bg-color' style=\"width:24px;height:4px;\"> </p>    </li>    <li class=\"info color-click\" style=\"float:left;width:10px;height:30px;margin:0;margin-left:5px;padding:0\">        <p class=\"color-click\" style=\"width:10px;height:4px;\"> </p> <i class=\"icon-caret-down color-click\" style=\" display:inline-block;width:10px;height:10px; color: rgb(158,161,164);;text-align:center; line-height: 10px;font-size:10px\"> </i>    </li></ul>",
