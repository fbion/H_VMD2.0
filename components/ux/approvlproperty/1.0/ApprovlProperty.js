Ext.define('vmd.ux.approvlProperty.Controller', {
    xtype: 'vmd.ux.approvlProperty.Controller',
    constructor: function(options) {}
})
Ext.define("vmd.ux.ApprovlProperty", {
    extend: "Ext.Panel",
    requires: vmd.getCmpDeps(["vmd.ux.ApprovlType$1.0$ApprovlType", "vmd.ux.Approval_Event$1.0$Approval_Event"]),
    version: "1.0",
    ...
    height: 672,
    layout: "fit",
    afterrender: "ApprovlProperty_afterrender",
    listeners: {
        vmdafterrender: function() {
            try {
                this.ApprovlProperty_afterrender(this)
            } catch (ex) {
                vmd.Error.log('003-2', {
                    p1: 'vmd.ux.ApprovlProperty'
                }, ex, 50);
            }
        }
    },
    ...
    initComponent: function() {
        ...
        this.ApprovlProperty_afterrender = ApprovlProperty_afterrender;
        this.items = [{
            xtype: "tabpanel",
            id: "MyTabs",
            activeTab: 0,
            ...
            items: [{
                    ...
                    items: [{
                        ...
                        id: "ApprovlType",
                        layout: "absolute",
                        spzj_decimalChanged: "ApprovlType_spzj_decimalChanged",
                        listeners: {
                            spzj_decimalChanged: ApprovlType_spzj_decimalChanged
                        }
                    }]
        ...
        Ext.util.CSS.removeStyleSheet("vmd.ux.ApprovlProperty");
        this.uxCss && Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.ApprovlProperty");
    }
})