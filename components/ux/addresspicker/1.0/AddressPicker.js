Ext.define("vmd.ux.AddressPicker" ,{
	extend:"Ext.Panel",
...
return _setValue(province_id, city_id, county_id, detail_info);
	...
	Ext.util.CSS.removeStyleSheet("vmd.ux.AddressPicker");
		this.uxCss&&Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.AddressPicker");
	}
})