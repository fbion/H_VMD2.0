Ext.define("vmd.ux.TabProjectInfoNew" ,{
	extend:"Ext.Panel",
	...
	height:422,
	layout:"absolute",
	beforerender:"TabProjectInfoNew_beforerender",
	afterrender:"TabProjectInfoNew_afterrender",
	listeners:{
		beforerender:function(){
	this.TabProjectInfoNew_beforerender(this)
},
		vmdafterrender:function(){
	this.TabProjectInfoNew_afterrender(this)
}
	},
...
function TabProjectInfoNew_beforerender(sender) {
...
function TabProjectInfoNew_afterrender(sender) {
    TabWorkSpaceResource.iSetApplyType(1);
...
function button_click(sender,e){
    ...
    var formAddWsMembers = new parent.vmd.window({
        title: "添加项目成员",
        url: parent.vmd.core.getVirtualPath() + "/modules/eQ9ULgcVb1/hwipUwNjJb/hwdHH9CSl6/hwlUPa7dB4.html",
        // url: parent.vmd.core.getVirtualPath() + "/modules/eQ9ULgcVb1/hwipUwNjJb/hwdHH9CSl6/hw2jghimLA.html",
...
function button3_click(sender,e){
    var formRoleAuthority = new vmd.window({
        title: "角色管理",
        url: vmd.core.getVirtualPath() + "/modules/eQ9ULgcVb1/hwipUwNjJb/hwdHH9CSl6/hwuOI64RIT.html",
        // url: vmd.core.getVirtualPath() + "/modules/eQ9ULgcVb1/hwipUwNjJb/hwdHH9CSl6/hwvasfOQqK.html",
        auto: false,
        height: 404,
        width: 624,
        maximizable: false,
    ...
    formRoleAuthority.show();
			...
			this.TabProjectInfoNew_afterrender=TabProjectInfoNew_afterrender;
		this.TabProjectInfoNew_beforerender=TabProjectInfoNew_beforerender;
		this.items=[
			{
				xtype:"tabpanel",
				id:"TabsProjectInfo",
...
workspaceId = id;
	...
	Ext.util.CSS.removeStyleSheet("vmd.ux.TabProjectInfoNew");
		this.uxCss&&Ext.util.CSS.createStyleSheet(this.uxCss, "vmd.ux.TabProjectInfoNew");
	}
})