Ext.define("vmd.ux.DetailsofUnitsSn" ,{
	extend:"Ext.Panel",
	...
	height:350,
	layout:"fit",
	afterrender:"DetailsofUnitsSn_afterrender",
	listeners:{
		vmdafterrender:function(){
	this.DetailsofUnitsSn_afterrender(this)
}
	},
...
loginInfo();
			...
			this.DetailsofUnitsSn_afterrender=DetailsofUnitsSn_afterrender;
		this.items=[
			{
				xtype:"panel",
				id:"panel",
		...
		resetCmpScope();
		Ext.util.CSS.removeStyleSheet("vmd.ux.DetailsofUnitsSn");
		this.uxCss&&Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.DetailsofUnitsSn");
	}
})