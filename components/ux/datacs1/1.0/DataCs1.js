Ext.define("vmd.ux.DataCs1", {
    ...
    initComponent: function() {
        ...
        eval(me.defineVars);
        resetCmpScope();
        Ext.util.CSS.removeStyleSheet("vmd.ux.DataCs1");
        this.uxCss && Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.DataCs1");
    }
})