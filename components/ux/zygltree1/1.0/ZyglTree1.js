...
//直接填写方法内容
 ...
 var id="";
	...
	Ext.util.CSS.removeStyleSheet("vmd.ux.ZyglTree1");
		this.uxCss&&Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.ZyglTree1");
	}
})