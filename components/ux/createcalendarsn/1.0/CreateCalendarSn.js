Ext.define("vmd.ux.CreateCalendarSn" ,{
	extend:"Ext.Panel",
	...
	autoHeight:false,
	region:"10",
	afterrender:"CreateCalendarSn_afterrender",
	unstyled:false,
	autoScroll:false,
	listeners:{
		vmdafterrender:function(){
	this.CreateCalendarSn_afterrender(this)
}
	},
...
function CreateCalendarSn_afterrender(sender) {
...
function hwDate1_select(sender, date) {
    ...
    //contrastSze(bz);
			...
			this.CreateCalendarSn_afterrender=CreateCalendarSn_afterrender;
		this.items=[
			{
				xtype:"label",
				id:"label",
...
hwDate1.setValue(jsrq);
	...
	Ext.util.CSS.removeStyleSheet("vmd.ux.CreateCalendarSn");
		this.uxCss&&Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.CreateCalendarSn");
	}
})