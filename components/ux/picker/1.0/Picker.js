Ext.define('vmd.ux.picker.Controller', {
    xtype: 'vmd.ux.picker.Controller',
    constructor: function(options) {}
})
Ext.define("vmd.ux.Picker", {
    extend: "Ext.Panel",
    ...
    baseCls: "",
    cls: "ys",
    beforerender: "Picker_beforerender",
    listeners: {
        beforerender: function() {
            this.Picker_beforerender(this)
        }
    },
    detailWidth: 200,
    comboWidth: 300,
    ...
    initComponent: function() {
        ...
        function picker_show(flag) {
            ...
            combo.addClass('addr1')
            //  debugger
            Ext.getBody().appendChild(div.el);
            div.show();
            div.setPosition(combo.getPosition()[0], combo.getPosition()[1] + 20)
            if (g == 1 && !flag) {
                return;
            }
            if (!flag) {
        ...
        function detail_keyup(sender, e) {
            page.fireEvent("detailkeyup", sender, e);
        }

        function Picker_beforerender(sender) {}
        this.Picker_beforerender = Picker_beforerender;
        this.items = [{
                xtype: "vmd.combo",
                id: "combo",
        ...
        Ext.util.CSS.removeStyleSheet("vmd.ux.Picker");
        this.uxCss && Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.Picker");
    }
})