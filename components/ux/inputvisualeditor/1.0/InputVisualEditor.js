Ext.define('vmd.ux.inputVisualEditor.Controller', {
    xtype: 'vmd.ux.inputVisualEditor.Controller',
    constructor: function(options) {}
})
Ext.define("vmd.ux.InputVisualEditor", {
    extend: "Ext.Panel",
    requires: vmd.getCmpDeps(),
    version: "1.0",
    xtype: "vmd.ux.InputVisualEditor",
    title: "Panel",
    header: false,
    border: false,
    width: 845,
    ...
    initComponent: function() {
        ...
        function InputVisualEditor_afterrender(sender) {
            // 
            if (needInfo == "true") {
                ColorDiv.show()
            } else {
            ...
            // alert(parent.params)
            var a = parent.expWin.params.expression;
            if (a != undefined) {
                a.trim()
            }
            if (a == " " || a == '&nbsp' || a == " ") {
        ...
        function determine_click(sender, e) {
            ...
            parent.inputExpressionWindowButtonY(exp);
            parent.expWin.hide()
        }
        ...
        this.InputVisualEditor_afterrender = InputVisualEditor_afterrender;
        this.items = [{
                xtype: "label",
                id: "label",
                text: "表达式：",
        ...
        Ext.util.CSS.removeStyleSheet("vmd.ux.InputVisualEditor");
        this.uxCss && Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.InputVisualEditor");
    }
})