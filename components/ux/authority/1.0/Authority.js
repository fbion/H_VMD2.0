Ext.define("vmd.ux.Authority" ,{
	...
	height:363,
	layout:"absolute",
	beforerender:"Authority_beforerender",
	listeners:{
		beforerender:function(){
	this.Authority_beforerender(this)
}
	},
...
function Authority_beforerender(sender) {

    // console.log("第一层的Authority_beforerender");
}
...
function comlistDataServiceAddress_selectChanged(sender, combo, record, index) {
    comlistDataServiceAddress.serviceId = record.data.id;
			...
			this.Authority_beforerender=Authority_beforerender;
		this.items=[
			{
				xtype:"panel",
				id:"panelAuthority",
...
dataserviceStoreRecords = records;
	...
	Ext.util.CSS.removeStyleSheet("vmd.ux.Authority");
		this.uxCss&&Ext.util.CSS.createStyleSheet(this.uxCss, "vmd.ux.Authority");
	}
})