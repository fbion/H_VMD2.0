...
Ext.define("vmd.ux.VisualEditorEx", {
    extend: "Ext.Panel",
    ...
    height: 482,
    layout: "absolute",
    afterrender: "VisualEditorEx_afterrender",
    listeners: {
        vmdafterrender: function() {
            try {
                this.VisualEditorEx_afterrender(this)
            } catch (ex) {
                vmd.Error.log('003-2', {
                    p1: 'vmd.ux.VisualEditorEx'
                }, ex, 50);
            }
        }
    },
    ...
    initComponent: function() {
        ...
        this.VisualEditorEx_afterrender = VisualEditorEx_afterrender;
        this.items = [{
                xtype: "label",
                id: "label",
                text: "表达式：",
        ...
        Ext.util.CSS.removeStyleSheet("vmd.ux.VisualEditorEx");
        this.uxCss && Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.VisualEditorEx");
    }
})