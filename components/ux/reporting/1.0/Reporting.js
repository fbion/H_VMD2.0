    ...
    initComponent: function() {
        ...
        try {
            ...
            function button2_click(sender, e) {
                ...
                if (typeof sheetHot == 'undefined') vmd.alert('警告', '请首先选择嵌套表子表任意单元格激活子表填报设置')
                debugger
                if (typeof sheetHot != 'undefined') parent.openVisualEditor(9, re_expression.getValue());
            }
        ...
        Ext.util.CSS.removeStyleSheet("vmd.ux.Reporting");
        this.uxCss && Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.Reporting");
    }
})