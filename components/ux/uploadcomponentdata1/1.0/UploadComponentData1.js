Ext.define("vmd.ux.UploadComponentData1" ,{
	extend:"Ext.Panel",
...
if(info){
	...
	Ext.util.CSS.removeStyleSheet("vmd.ux.UploadComponentData1");
		this.uxCss&&Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.UploadComponentData1");
	}
})