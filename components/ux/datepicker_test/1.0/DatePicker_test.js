...
Ext.define("vmd.ux.DatePicker_test", {
    extend: "Ext.Panel",
    ...
    autoWidth: false,
    cls: "vmd-datepicker",
    beforerender: "DatePicker_test_beforerender",
    afterrender: "DatePicker_test_afterrender",
    listeners: {
        beforerender: function() {
            this.DatePicker_test_beforerender(this)
        },
        vmdafterrender: function() {
            this.DatePicker_test_afterrender(this)
        }
    },
    ...
    initComponent: function() {
        ...
        function DatePicker_test_beforerender(sender) {
            //动态加载样式
            //this.autoWidth = true;
            //防止样式重复加载
        ...
        function DatePicker_test_afterrender(sender, rq1, rq2) {
            //构造内部对象
            //var me=this;
            //是否range连续选择
        ...
        function _setValue(rq1, rq2) {
            ...
            // })
            DatePicker_test_afterrender.call(page, page, rq1, rq2);
        }
        this.DatePicker_test_afterrender = DatePicker_test_afterrender;
        this.DatePicker_test_beforerender = DatePicker_test_beforerender;
        this.items = [{
            xtype: "vmd.div",
            id: "hiddenInfo",
            autoEl: "div",
        ...
        Ext.util.CSS.removeStyleSheet("vmd.ux.DatePicker_test");
        this.uxCss && Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.DatePicker_test");
    }
})