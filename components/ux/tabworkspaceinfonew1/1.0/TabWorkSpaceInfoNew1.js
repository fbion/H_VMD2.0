Ext.define("vmd.ux.TabWorkSpaceInfoNew1" ,{
	extend:"Ext.Panel",
	...
	height:397,
	layout:"absolute",
	beforerender:"TabWorkSpaceInfoNew1_beforerender",
	listeners:{
		beforerender:function(){
	this.TabWorkSpaceInfoNew1_beforerender(this)
}
	},
...
function TabWorkSpaceInfoNew1_beforerender(sender) {

    // console.log("第一层的TabWorkSpaceInfoNew1_beforerender");
}
...
function comlistDataServiceAddress_selectChanged(sender, combo, record, index) {
    comlistDataServiceAddress.serviceId = record.data.id;
			...
			this.TabWorkSpaceInfoNew1_beforerender=TabWorkSpaceInfoNew1_beforerender;
		this.items=[
			{
				xtype:"tabpanel",
...
dataserviceStoreRecords = records;
	...
	Ext.util.CSS.removeStyleSheet("vmd.ux.TabWorkSpaceInfoNew1");
		this.uxCss&&Ext.util.CSS.createStyleSheet(this.uxCss, "vmd.ux.TabWorkSpaceInfoNew1");
	}
})