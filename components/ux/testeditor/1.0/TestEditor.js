...
Ext.define("vmd.ux.TestEditor", {
    ...
    initComponent: function() {
        ...
        this.TestEditor_afterrender = TestEditor_afterrender;
        this.callParent();
        vmd.core.compositeCmpInit(this.items, this);
        var me = this;
        eval(me.defineVars);
        resetCmpScope();
        Ext.util.CSS.removeStyleSheet("vmd.ux.TestEditor");
        this.uxCss && Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.TestEditor");
    }
})