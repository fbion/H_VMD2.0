Ext.define("vmd.ux.ColorSelectInner" ,{
	extend:"Ext.Panel",
	...
	height:621,
	layout:"absolute",
	afterrender:"ColorSelectInner_afterrender",
	listeners:{
		vmdafterrender:function(){
	this.ColorSelectInner_afterrender(this)
}
	},
...
function colorSelectInner_afterrender(sender) {
			...
			this.ColorSelectInner_afterrender=ColorSelectInner_afterrender;
		this.items=[
			{
				xtype:"vmd.div",
				id:"colorDisplay",
...
return selectColor; 
	...
	Ext.util.CSS.removeStyleSheet("vmd.ux.ColorSelectInner");
		this.uxCss&&Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.ColorSelectInner");
	}
})