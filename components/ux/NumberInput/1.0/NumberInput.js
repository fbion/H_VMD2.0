...
Ext.define("vmd.ux.NumberInput", {
    ...
    style: "border: 1px solid #ddd;    min-width: 50px;",
    afterrender: "NumberInput_afterrender",
    listeners: {
        vmdafterrender: function() {
            try {
                this.NumberInput_afterrender(this)
            } catch (ex) {
                vmd.Error.log('003-2', {
                    p1: 'vmd.ux.NumberInput'
                }, ex, 50);
            }
        }
    },
    initComponent: function() {
        ...
        try {
            ...
            function div_click(sender, e) {
                ...
                page.fireEvent("change", numSender, value, "szd")
            }
            ...
            function NumberInput_afterrender(sender) {
                numSender = sender;
            }
        } catch (ex) {
            vmd.Error.log('003-3', {
        ...
        this.NumberInput_afterrender = NumberInput_afterrender;
        this.items = [{
                xtype: "vmd.div",
                id: "hwDiv1",
                autoEl: "div",
        ...
        Ext.util.CSS.removeStyleSheet("vmd.ux.NumberInput");
        this.uxCss && Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.NumberInput");
    }
})