Ext.define("vmd.ux.DropDownTreeData" ,{
	extend:"Ext.Panel",
...
if(info){
	...
	Ext.util.CSS.removeStyleSheet("vmd.ux.DropDownTreeData");
		this.uxCss&&Ext.util.CSS.createStyleSheet(this.uxCss, "vmd.ux.DropDownTreeData");
	}
})