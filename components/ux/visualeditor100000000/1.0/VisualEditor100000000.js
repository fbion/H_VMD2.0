Ext.define("vmd.ux.VisualEditor100000000" ,{
	extend:"Ext.Panel",
	...
	height:482,
	layout:"absolute",
	afterrender:"VisualEditor100000000_afterrender",
	listeners:{
		vmdafterrender:function(){
	this.VisualEditor100000000_afterrender(this)
}
	},
...
function VisualEditor100000000_afterrender(sender) {
    // 
    if(needInfo == "true") {
        ColorDiv.show()
    } else {
...
function cancel_click(sender, e) {
    ...
    parent.expWin.hide()
			...
			this.VisualEditor100000000_afterrender=VisualEditor100000000_afterrender;
		this.items=[
			{
				xtype:"label",
				id:"label",
...
setInfo(info,cell);
	...
	Ext.util.CSS.removeStyleSheet("vmd.ux.VisualEditor100000000");
		this.uxCss&&Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.VisualEditor100000000");
	}
})