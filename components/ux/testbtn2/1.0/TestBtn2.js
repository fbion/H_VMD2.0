...
function hwDataView_afterrender(sender){
		...
		Ext.util.CSS.removeStyleSheet("vmd.ux.TestBtn2");
		this.uxCss&&Ext.util.CSS.createStyleSheet(this.uxCss, "vmd.ux.TestBtn2");
			me.on('vmdafterrender',function(){ TestBtn2_afterrender.call(me,me)})
