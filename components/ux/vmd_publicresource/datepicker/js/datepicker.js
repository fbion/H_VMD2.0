  ...
  $.extend(Day.prototype, {
    ...
    eventSingle: function () {
      ...
      function clickDate(_this,$target){
		...
		var oldval=_this.picker.$input.val();
		...
		var newval=_this.picker.$container.find('.c-datePicker__input-day').val();
		//change
		var newval=_this.picker.$input.val()
		_this.picker.config.select(newval);
		if(val!=newval) _this.picker.config.change(newval,oldval);
  ...
  $.extend(SingleDatePicker.prototype, {
    ...
    event: function () {
      ...
      this.$container.on('click', '.c-datepicker-picker__link-btn.confirm', function () {
		...
		_this.config.change(_this.$input.val(),_this.$input.val())	
        _this.datePickerObject.hide();
      });
    },
