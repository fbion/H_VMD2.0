...
var comData3 = [{
    ...
    id: 'GDF4-1',
    xm: '中一区馆4'
},{name:"ST1-0-7",id:"ST1-0-7",xm:"胜一区1-3扩大区"},
{name:"ST1-0-740",id:"ST1-0-740",xm:"胜一区1-3扩大区"},
{name:"ST1-0-71",id:"ST1-0-71",xm:"胜一区1-3扩大区"},
{name:"ST1-0-74",id:"ST1-0-74",xm:"胜一区1-3扩大区"}
]
...
return combo2.getValue()
	...
	Ext.util.CSS.removeStyleSheet("vmd.ux.Sctjxz1");
		this.uxCss&&Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.Sctjxz1");
	}
})