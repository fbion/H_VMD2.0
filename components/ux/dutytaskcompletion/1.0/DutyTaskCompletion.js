Ext.define("vmd.ux.DutyTaskCompletion" ,{
	extend:"Ext.Panel",
...
window.rwmcLink=function(id){
    var tr = $(id).closest('tr'), id = tr.find('td')[0].innerText;
		...
		resetCmpScope();
		Ext.util.CSS.removeStyleSheet("vmd.ux.DutyTaskCompletion");
		this.uxCss&&Ext.util.CSS.createStyleSheet(vmd.replaceResVars(this.uxCss), "vmd.ux.DutyTaskCompletion");
	}
})