Ext.define("vmd.ux.Ordinary_Data" ,{
	extend:"Ext.Panel",
...
if(info){
	...
	Ext.util.CSS.removeStyleSheet("vmd.ux.Ordinary_Data");
		this.uxCss&&Ext.util.CSS.createStyleSheet(this.uxCss, "vmd.ux.Ordinary_Data");
	}
})