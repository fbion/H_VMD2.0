Ext.define("vmd.ux.TestBtn_btn3" ,{
	extend:"Ext.Panel",
	requires:vmd.getCmpDeps(["vmd.ux.TestBtn$1.0$TestBtn"]),
	version:"1.0",
	xtype:"vmd.ux.TestBtn_btn3",
	title:"Panel",
	header:false,
	border:false,
	width:1057,
	height:529,
	layout:"absolute",
	afterrender:"TestBtn_btn3_afterrender",
	initComponent: function(){
		function TestBtn_afterrender(sender){

}

function TestBtn_btn3_afterrender(sender){
...
function hwDataView_afterrender(sender){
		...
		Ext.util.CSS.removeStyleSheet("vmd.ux.TestBtn_btn3");
		this.uxCss&&Ext.util.CSS.createStyleSheet(this.uxCss, "vmd.ux.TestBtn_btn3");
			me.on('vmdafterrender',function(){ TestBtn_btn3_afterrender.call(me,me)})
		me.TestBtn.on('vmdafterrender',function(){ TestBtn_afterrender.call(me.TestBtn,me.TestBtn)})
		me.hwDataView.on('vmdafterrender',function(){ hwDataView_afterrender.call(me.hwDataView,me.hwDataView)})
}
})