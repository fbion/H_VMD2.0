 ...
 ** 版 本:1.1
 ******************************************************************/
Ext.define('vmd.webchart.IsoArea',{
	extend:'vmd.base.WebChart',
	xtype:'vmd.webchart.isoArea',
	requires:[
	...
	onRender: function(ct, position) {
		...
		// vmd.MicService.getGrapDasIp(),图形数据解析
		// vmd.MicService.getGrapAasIp()  图形算法
		...
		if(me.path){
			...
			var path = vmd.virtualPath + '/templates/defaults/kczb.json';
