function eXcell_hwSimpleGridLink(cell) {
	...
	this.setValue = function(val) {
		...
		var cell = this.cell;
		var cval = val
		var cellInfo=this.grid._simpleGridShowValue[this.cell._cellIndex]
		if(cellInfo&&cellInfo.fileInfo&&cellInfo.fileInfo.lineFeed)
		{
			cell.style.whiteSpace="normal"
			cell.style.wordBreak="break-eord"
		}
...
function eXcell_hwSimpleGridTxt(cell) {
	...
	this.setValue = function(val) {
		...
		if(this.grid._simpleGridShowValue[this.cell._cellIndex])
