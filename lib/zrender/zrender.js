 ...
 * hwcharts设备环境识别
 *
 * @desc hwcharts基于Canvas，纯Javascript图表库，提供直观，生动，可交互，可个性化定制的数据统计图表。
 ...
 * So date should not be modified in and out of hwcharts.
 *
 * @param {*} source
 * @return {*} new
 */
...
function addEventListener(el, name, handler, opt) {
    if (isDomLevel2) {
        ...
        // to prevent default. For example, the feature `preventDefaultMouseMove` of hwcharts.
 ...
 * not provided (like hwcharts-gl did).
...
/**
 * @module hwcharts/animation/Animator
 */
...
/**
 * @module hwcharts/core/BoundingRect
 */
...
/**
 * @alias module:hwcharts/core/BoundingRect
 */
...
BoundingRect.prototype = {
    ...
    /**
     * @param {module:hwcharts/core/BoundingRect} other
     */
    ...
    /**
     * @param {(module:hwcharts/core/BoundingRect|Object)} b
     * @return {boolean}
     */
    ...
    /**
     * @return {module:hwcharts/core/BoundingRect}
     */
    clone: function () {
...
Style.prototype = {
     ...
     * (e.g., emphasis.lineStyle in hwcharts)
     ...
     * So do not visit it directly in upper application (like hwcharts),
...
Painter.prototype = {
    ...
    getRenderedCanvas: function (opts) {
        ...
        if (opts.pixelRatio <= this.dpr) {
            ...
            // PENDING, hwcharts-gl and incremental rendering.
            var scope = {};
...
Animation.prototype = {
    ...
    _update: function () {
        ...
        // depends on the sequence (e.g., hwcharts-stream and finish
        // event judge)
...
var localDOMHandlers = {
    ...
    mouseout: function (event) {
        ...
        // dom created by hwcharts), where 'globalout' event should not
...
Path.prototype = {
    ...
    // This item default to be false. But in map series in hwcharts,
...
exports.timsort = sort;
exports.getBoundingRect = getBoundingRect;
//exports.truncateText = truncateText;
exports.fixClipWithShadow = fixClipWithShadow;
exports.event = {
    stop: stop,
...
exports.windingLine = windingLine;
exports.Transformable = Transformable;
exports.Gradient = Gradient;
exports.contain = {
    quadratic: {
        containStroke: containStroke$3
    },
    line: {
        containStroke: containStroke$1
    },
    text: {
